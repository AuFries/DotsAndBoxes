A terminal-based dots and boxes game using ANSI escape sequences. The game is controlled with keyboard input and uses the Blessed module to streamline terminal commands and control loops.
